...
# Or manually:
docker build -t ghcr.io/your-org/sonatypeiq-mcp:latest -f deploy/docker/Dockerfile .

# Build and push to GitHub Container Registry (on push to main, CI does this automatically)
make build-image
docker push ghcr.io/your-org/sonatypeiq-mcp:latest
...
helm upgrade -i sonatypeiq-mcp deploy/helm \
  --set image.repository=ghcr.io/flowgent-labs/sonatypeiq-mcp \
