...
func ReviewPolicyWaiverRequestHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/policyWaiverRequests/{ownerType}/{ownerId}/review/{policyWaiverRequestId}", args, []string{"ownerId", "ownerType", "policyWaiverRequestId"}, contentType, "ReviewPolicyWaiverRequest")
}
