...
func EvaluateComponentsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/evaluation/applications/{applicationId}", args, []string{"applicationId"}, contentType, "EvaluateComponents")
}
