...
func AddBulkPolicyWaiversHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/policyWaivers/{ownerType}/{ownerId}", args, []string{"ownerId", "ownerType"}, contentType, "AddBulkPolicyWaivers")
}
