...
func AddPolicyWaiverRequestByPolicyViolationIdHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/policyWaiverRequests/{ownerType}/{ownerId}/policyViolation/{policyViolationId}", args, []string{"ownerId", "ownerType", "policyViolationId"}, contentType, "AddPolicyWaiverRequestByPolicyViolationId")
}
