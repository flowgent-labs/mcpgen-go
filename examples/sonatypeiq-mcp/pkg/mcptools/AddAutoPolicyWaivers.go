...
func AddAutoPolicyWaiversHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/autoPolicyWaivers/v2/{ownerType}/{ownerId}", args, []string{"ownerId", "ownerType"}, contentType, "AddAutoPolicyWaivers")
}
