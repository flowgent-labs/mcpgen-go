...
func SetFirewallAutoUnquarantineConfigHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/api/v2/firewall/releaseQuarantine/configuration", args, []string{}, contentType, "SetFirewallAutoUnquarantineConfig")
}
