...
func EvaluateComponents1Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/firewall/components/{repositoryManagerId}/{repositoryId}/evaluate", args, []string{"repositoryId", "repositoryManagerId"}, contentType, "EvaluateComponents1")
}
