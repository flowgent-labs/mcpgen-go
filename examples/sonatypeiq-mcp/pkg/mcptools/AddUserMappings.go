...
func AddUserMappingsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/sourceControl/automaticRoleAssignment/userMappings/{organizationId}", args, []string{"organizationId"}, contentType, "AddUserMappings")
}
