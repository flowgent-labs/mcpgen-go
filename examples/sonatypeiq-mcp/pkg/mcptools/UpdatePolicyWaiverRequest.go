...
func UpdatePolicyWaiverRequestHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/api/v2/policyWaiverRequests/{ownerType}/{ownerId}/{policyWaiverRequestId}", args, []string{"ownerId", "ownerType", "policyWaiverRequestId"}, contentType, "UpdatePolicyWaiverRequest")
}
