...
func UpdateArtifactoryConnectionHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/api/v2/config/artifactoryConnection/{ownerType}/{internalOwnerId}/{artifactoryConnectionId}", args, []string{"artifactoryConnectionId", "internalOwnerId", "ownerType"}, contentType, "UpdateArtifactoryConnection")
}
