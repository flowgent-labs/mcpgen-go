...
func UpdateTagHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/api/v2/applicationCategories/organization/{organizationId}", args, []string{"organizationId"}, contentType, "UpdateTag")
}
