...
func SaveAttributionReportTemplateHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/licenseLegalMetadata/report-template", args, []string{}, contentType, "SaveAttributionReportTemplate")
}
