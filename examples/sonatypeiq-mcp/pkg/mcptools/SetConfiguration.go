...
func SetConfigurationHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/api/v2/config/ci/{ownerType}/{ownerId}", args, []string{"ownerId", "ownerType"}, contentType, "SetConfiguration")
}
