...
func AddLicenseOverrideHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/licenseOverrides/{ownerType}/{ownerId}", args, []string{"ownerId", "ownerType"}, contentType, "AddLicenseOverride")
}
