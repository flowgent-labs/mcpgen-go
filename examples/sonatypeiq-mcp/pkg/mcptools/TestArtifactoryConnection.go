...
func TestArtifactoryConnectionHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/api/v2/config/artifactoryConnection/{ownerType}/{internalOwnerId}/test", args, []string{"internalOwnerId", "ownerType"}, contentType, "TestArtifactoryConnection")
}
