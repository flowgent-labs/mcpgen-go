...
USAGE
  cat <<'EOEX'
  # Add (POST)
  ./mcpclient.sh call Add '{"body": {"password": "password_value", "realm": "realm_value", "username": "username_value", "email": "email_value", "firstName": "firstName_value", "lastName": "lastName_value"}}'
EOEX
  cat <<'EOEX'
  # AddApplication (POST)
...
EOEX
  ...
  ./mcpclient.sh call AddArtifactoryConnection '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"ownerId": "ownerId_value", "ownerType": "application", "password": "password_value", "username": "username_value", "artifactoryConnectionId": "artifactoryConnectionId_value", "baseUrl": "baseUrl_value", "isAnonymous": false}}'
EOEX
  cat <<'EOEX'
...
EOEX
  ...
  ./mcpclient.sh call AddAutoPolicyWaiver '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"publicId": "publicId_value", "createTime": "2025-01-01", "ownerName": "ownerName_value", "scopesOperatorAny": false, "autoPolicyWaiverId": "autoPolicyWaiverId_value", "ownerId": "ownerId_value", "ownerType": "ownerType_value", "reachability": false, "threatLevel": 0, "creatorId": "creatorId_value", "creatorName": "creatorName_value", "pathForward": false}}'
EOEX
  cat <<'EOEX'
...
EOEX
  ...
  ./mcpclient.sh call AddLicenseOverride '{"ownerId": "ownerId_value", "ownerType": "application", "where": "where_value", "body": {"comment": "comment_value", "componentIdentifier": {}, "id": "id_value", "licenseIds": [], "ownerId": "ownerId_value", "status": "OPEN"}}'
EOEX
  cat <<'EOEX'
...
EOEX
  cat <<'EOEX'
  # AddRole (POST)
  ./mcpclient.sh call AddRole '{"body": {"name": "name_value", "permissionCategories": [], "builtIn": false, "description": "description_value", "id": "id_value"}}'
EOEX
  cat <<'EOEX'
  # AddSourceControl (POST)
  ./mcpclient.sh call AddSourceControl '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"id": "id_value", "innerSourceAutomatedUpdatesEnabled": false, "closePrAfterDays": 0, "sshEnabled": false, "sourceControlEvaluationsEnabled": false, "remediationPullRequestsEnabled": false, "token": "token_value", "commitStatusEnabled": false, "manualPullRequestsEnabled": false, "statusChecksEnabled": false, "authenticationType": "authenticationType_value", "enablePullRequests": false, "sourceControlScanTarget": "sourceControlScanTarget_value", "username": "username_value", "githubAppId": "githubAppId_value", "nonGoldenPullRequestsEnabled": false, "repositoryUrl": "repositoryUrl_value", "provider": "provider_value", "baseBranch": "baseBranch_value", "closePrAfterDaysOpenEnabled": false, "pullRequestCommentingEnabled": false, "enableStatusChecks": false, "ownerId": "ownerId_value", "closePrOnFailedChecksEnabled": false}}'
EOEX
  cat <<'EOEX'
  # AddTag (POST)
