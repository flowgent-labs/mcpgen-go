#!/usr/bin/env bash
# Generated by https://github.com/flowgent-labs/mcpgen-go
set -euo pipefail
...
EOEX
  ...
  ./mcpclient.sh call AddAutoPolicyWaiveExclusion '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"scanId": "scanId_value", "applicationPublicId": "applicationPublicId_value", "autoPolicyWaiverId": "autoPolicyWaiverId_value", "matchStrategy": "EXACT_COMPONENT", "ownerId": "ownerId_value", "policyViolationId": "policyViolationId_value"}}'
EOEX
  cat <<'EOEX'
  # AddAutoPolicyWaiver (POST)
  ./mcpclient.sh call AddAutoPolicyWaiver '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"ownerName": "ownerName_value", "scopesOperatorAny": false, "autoPolicyWaiverId": "autoPolicyWaiverId_value", "ownerType": "ownerType_value", "creatorName": "creatorName_value", "pathForward": false, "reachability": false, "createTime": "2025-01-01", "creatorId": "creatorId_value", "threatLevel": 0, "publicId": "publicId_value", "ownerId": "ownerId_value"}}'
EOEX
  cat <<'EOEX'
...
EOEX
  ...
  ./mcpclient.sh call AddSourceControl '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"remediationPullRequestsEnabled": false, "manualPullRequestsEnabled": false, "innerSourceAutomatedUpdatesEnabled": false, "username": "username_value", "closePrAfterDays": 0, "sshEnabled": false, "token": "token_value", "enablePullRequests": false, "authenticationType": "authenticationType_value", "githubAppId": "githubAppId_value", "pullRequestCommentingEnabled": false, "closePrOnFailedChecksEnabled": false, "sourceControlScanTarget": "sourceControlScanTarget_value", "closePrAfterDaysOpenEnabled": false, "enableStatusChecks": false, "ownerId": "ownerId_value", "provider": "provider_value", "sourceControlEvaluationsEnabled": false, "repositoryUrl": "repositoryUrl_value", "commitStatusEnabled": false, "baseBranch": "baseBranch_value", "id": "id_value", "statusChecksEnabled": false, "nonGoldenPullRequestsEnabled": false}}'
EOEX
  cat <<'EOEX'
  # AddTag (POST)
