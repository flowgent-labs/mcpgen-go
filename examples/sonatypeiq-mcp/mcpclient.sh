...
EOEX
  ...
  ./mcpclient.sh call AddAutoPolicyWaiveExclusion '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"ownerId": "ownerId_value", "policyViolationId": "policyViolationId_value", "scanId": "scanId_value", "applicationPublicId": "applicationPublicId_value", "autoPolicyWaiverId": "autoPolicyWaiverId_value", "matchStrategy": "EXACT_COMPONENT"}}'
EOEX
  cat <<'EOEX'
  # AddAutoPolicyWaiver (POST)
  ./mcpclient.sh call AddAutoPolicyWaiver '{"ownerId": "ownerId_value", "ownerType": "application", "body": {"ownerId": "ownerId_value", "createTime": "2025-01-01", "pathForward": false, "creatorName": "creatorName_value", "ownerName": "ownerName_value", "reachability": false, "creatorId": "creatorId_value", "scopesOperatorAny": false, "autoPolicyWaiverId": "autoPolicyWaiverId_value", "ownerType": "ownerType_value", "publicId": "publicId_value", "threatLevel": 0}}'
EOEX
  cat <<'EOEX'
...
EOEX
  cat <<'EOEX'
  # AddRole (POST)
  ./mcpclient.sh call AddRole '{"body": {"description": "description_value", "id": "id_value", "name": "name_value", "permissionCategories": [], "builtIn": false}}'
EOEX
  cat <<'EOEX'
  # AddSourceControl (POST)
  ./mcpclient.sh call AddSourceControl '{"internalOwnerId": "internalOwnerId_value", "ownerType": "application", "body": {"ownerId": "ownerId_value", "commitStatusEnabled": false, "pullRequestCommentingEnabled": false, "baseBranch": "baseBranch_value", "closePrAfterDaysOpenEnabled": false, "githubAppId": "githubAppId_value", "manualPullRequestsEnabled": false, "closePrAfterDays": 0, "remediationPullRequestsEnabled": false, "enablePullRequests": false, "repositoryUrl": "repositoryUrl_value", "closePrOnFailedChecksEnabled": false, "sourceControlEvaluationsEnabled": false, "innerSourceAutomatedUpdatesEnabled": false, "nonGoldenPullRequestsEnabled": false, "statusChecksEnabled": false, "id": "id_value", "enableStatusChecks": false, "sshEnabled": false, "authenticationType": "authenticationType_value", "username": "username_value", "provider": "provider_value", "token": "token_value", "sourceControlScanTarget": "sourceControlScanTarget_value"}}'
EOEX
  cat <<'EOEX'
  # AddTag (POST)
