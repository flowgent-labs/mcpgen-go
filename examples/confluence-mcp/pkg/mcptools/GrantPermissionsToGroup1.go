...
func GrantPermissionsToGroup1Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/confluence/rest/api/space/{spaceKey}/permissions/group/{groupName}/grant", args, []string{"groupName", "spaceKey"}, contentType, "GrantPermissionsToGroup1")
}
