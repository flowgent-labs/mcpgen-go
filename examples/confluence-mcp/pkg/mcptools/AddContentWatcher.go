...
func AddContentWatcherHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/confluence/rest/api/user/watch/content/{contentId}", args, []string{"contentId"}, contentType, "AddContentWatcher")
}
