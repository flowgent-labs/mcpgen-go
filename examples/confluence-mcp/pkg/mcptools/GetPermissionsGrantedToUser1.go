...
func GetPermissionsGrantedToUser1Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/confluence/rest/api/space/{spaceKey}/permissions/user/{userKey}", args, []string{"spaceKey", "userKey"}, contentType, "GetPermissionsGrantedToUser1")
}
