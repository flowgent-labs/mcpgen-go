...
func RevokePermissionsFromUnlicensedUsersHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/confluence/rest/api/permissions/unlicensed/revoke", args, []string{}, contentType, "RevokePermissionsFromUnlicensedUsers")
}
