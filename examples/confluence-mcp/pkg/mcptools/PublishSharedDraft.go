...
func PublishSharedDraftHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/confluence/rest/api/content/blueprint/instance/{draftId}", args, []string{"draftId"}, contentType, "PublishSharedDraft")
}
