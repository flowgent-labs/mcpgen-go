...
import (
	...
	"sonatypeiq-mcp-v1.203.0-01/internal/mcptools"

	"sonatypeiq-mcp-v1.203.0-01/internal/mcpaggregator/engine"
...
func NewMCPServer() *server.MCPServer {
	s := server.NewMCPServer(
		"sonatypeiq-mcp-v1.203.0-01 MCP Server",
		"1.0.0",
	...
	cfg, _ := mcputils.LoadConfig("sonatypeiq-mcp-v1.203.0-01")
	...
	aggConfigPath := mcputils.AggregatedConfigPath("sonatypeiq-mcp-v1.203.0-01")
