...
# Run the HTTP mode
./bin/sonatypeiq-mcp-v1.203.0-01 --transport http --port 8080 &

# Run the CLI mode
./bin/sonatypeiq-mcp-v1.203.0-01 -t cli list
...
./bin/sonatypeiq-mcp-v1.203.0-01 --print-default-config

# Create and edit your config
mkdir -p ~/.sonatypeiq-mcp-v1.203.0-01
./bin/sonatypeiq-mcp-v1.203.0-01 --print-default-config > ~/.sonatypeiq-mcp-v1.203.0-01/config.yaml
```

Edit `~/.sonatypeiq-mcp-v1.203.0-01/config.yaml` and set `tools.include` to the operation IDs you want:
...
```json
{
  "mcp": {
    "sonatypeiq-mcp-v1.203.0-01": {
      "type": "local",
      "command": ["./sonatypeiq-mcp-v1.203.0-01"],
...
export MCP_UPSTREAM_ENDPOINT=https://api.example.com
export MCP_UPSTREAM_TOKEN=your-token
./sonatypeiq-mcp-v1.203.0-01 --transport http --port 8080
```
