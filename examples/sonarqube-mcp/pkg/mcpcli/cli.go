...
func ListTools() {
	...
	if len(nativeTools) == 0 {
		fmt.Fprintf(os.Stderr, "Warning: no native tools are enabled. To expose native tools, set tools.expose.register-all-tools-by-default: true or add tool names to tools.expose.includes in ~/.sonarqube-mcp/config.yaml\n")
	}
