...
import (
	...
	mcptools "jira-mcp/pkg/mcptools"

	"jira-mcp/pkg/mcpvirtual/engine"
	"jira-mcp/pkg/mcpvirtual/pipeline"
)
...
func loadVirtualTools() map[string]pipeline.VirtualToolEntry {
	cfgPath := mcputils.VirtualConfigPath("jira-mcp")
...
func ListTools() {
	cfg, _ := mcputils.LoadConfig("jira-mcp")
