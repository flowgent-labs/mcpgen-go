...
func GetIssuesForSprintHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/agile/1.0/board/{boardId}/sprint/{sprintId}/issue", args, []string{"boardId", "sprintId"}, contentType, "GetIssuesForSprint")
}
