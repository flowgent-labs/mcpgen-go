...
func UpdateWorklogHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/rest/api/2/issue/{issueIdOrKey}/worklog/{id}", args, []string{"id", "issueIdOrKey"}, contentType, "UpdateWorklog")
}
