...
func AssignPermissionSchemeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/rest/api/2/project/{projectKeyOrId}/permissionscheme", args, []string{"projectKeyOrId"}, contentType, "AssignPermissionScheme")
}
