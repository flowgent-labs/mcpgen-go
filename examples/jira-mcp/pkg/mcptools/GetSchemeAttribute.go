...
func GetSchemeAttributeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/permissionscheme/{permissionSchemeId}/attribute/{attributeKey}", args, []string{"attributeKey", "permissionSchemeId"}, contentType, "GetSchemeAttribute")
}
