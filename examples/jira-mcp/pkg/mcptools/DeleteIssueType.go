...
func DeleteIssueTypeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "DELETE", "/rest/api/2/workflowscheme/{id}/issuetype/{issueType}", args, []string{"id", "issueType"}, contentType, "DeleteIssueType")
}
