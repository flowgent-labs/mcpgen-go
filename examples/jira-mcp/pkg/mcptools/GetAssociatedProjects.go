...
func GetAssociatedProjectsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/issuetypescheme/{schemeId}/associations", args, []string{"schemeId"}, contentType, "GetAssociatedProjects")
}
