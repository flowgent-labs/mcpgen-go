...
func UnassignPrioritySchemeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "DELETE", "/rest/api/2/project/{projectKeyOrId}/priorityscheme/{schemeId}", args, []string{"projectKeyOrId", "schemeId"}, contentType, "UnassignPriorityScheme")
}
