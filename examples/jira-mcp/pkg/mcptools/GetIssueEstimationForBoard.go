...
func GetIssueEstimationForBoardHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/agile/1.0/issue/{issueIdOrKey}/estimation", args, []string{"issueIdOrKey"}, contentType, "GetIssueEstimationForBoard")
}
