...
func GetNotificationScheme1Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/project/{projectKeyOrId}/notificationscheme", args, []string{"projectKeyOrId"}, contentType, "GetNotificationScheme1")
}
