...
func GetPermissionSchemeGrantHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/permissionscheme/{schemeId}/permission/{permissionId}", args, []string{"permissionId", "schemeId"}, contentType, "GetPermissionSchemeGrant")
}
