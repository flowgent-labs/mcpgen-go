...
func GetRemoteVersionLinkHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/version/{versionId}/remotelink/{globalId}", args, []string{"globalId", "versionId"}, contentType, "GetRemoteVersionLink")
}
