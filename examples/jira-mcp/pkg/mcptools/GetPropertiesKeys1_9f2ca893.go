...
func GetPropertiesKeys1_9f2ca893Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/comment/{commentId}/properties", args, []string{"commentId"}, contentType, "GetPropertiesKeys1_9f2ca893")
}
