...
func GetPropertiesKeys1_9f2ca893Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/agile/1.0/sprint/{sprintId}/properties", args, []string{"sprintId"}, contentType, "GetPropertiesKeys1_9f2ca893")
}
