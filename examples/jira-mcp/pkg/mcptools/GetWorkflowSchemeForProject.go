...
func GetWorkflowSchemeForProjectHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/project/{projectKeyOrId}/workflowscheme", args, []string{"projectKeyOrId"}, contentType, "GetWorkflowSchemeForProject")
}
