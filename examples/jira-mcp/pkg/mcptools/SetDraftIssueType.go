...
func SetDraftIssueTypeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/rest/api/2/workflowscheme/{id}/draft/issuetype/{issueType}", args, []string{"id", "issueType"}, contentType, "SetDraftIssueType")
}
