...
func AssignPrioritySchemeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/rest/api/2/project/{projectKeyOrId}/priorityscheme", args, []string{"projectKeyOrId"}, contentType, "AssignPriorityScheme")
}
