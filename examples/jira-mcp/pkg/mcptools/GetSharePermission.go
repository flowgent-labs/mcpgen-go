...
func GetSharePermissionHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/filter/{id}/permission/{permissionId}", args, []string{"id", "permissionId"}, contentType, "GetSharePermission")
}
