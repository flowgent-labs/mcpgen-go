...
func DeleteDraftIssueTypeHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "DELETE", "/rest/api/2/workflowscheme/{id}/draft/issuetype/{issueType}", args, []string{"id", "issueType"}, contentType, "DeleteDraftIssueType")
}
