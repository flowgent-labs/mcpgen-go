...
func GetCustomFieldOptionsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	contentType := ""
	return mcputils.ForwardAndParseResponse(ctx, upstream, "GET", "/rest/api/2/customFields/{customFieldId}/options", args, []string{"customFieldId"}, contentType, "GetCustomFieldOptions")
}
