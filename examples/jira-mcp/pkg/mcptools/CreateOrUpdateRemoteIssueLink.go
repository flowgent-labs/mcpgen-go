...
func CreateOrUpdateRemoteIssueLinkHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "POST", "/rest/api/2/issue/{issueIdOrKey}/remotelink", args, []string{"issueIdOrKey"}, contentType, "CreateOrUpdateRemoteIssueLink")
}
