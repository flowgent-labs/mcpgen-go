...
func SetProperty1_9fc616f7Handler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return mcputils.ForwardAndParseResponse(ctx, upstream, "PUT", "/rest/api/2/comment/{commentId}/properties/{propertyKey}", args, []string{"commentId", "propertyKey"}, contentType, "SetProperty1_9fc616f7")
}
