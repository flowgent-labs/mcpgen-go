...
func TestBuildImportPath(t *testing.T) {
	testCases := []struct {
		...
		{"simple", "mymcpserver", "mymcpserver/pkg/mcptools"},
		{"nested", "output/myserver", "myserver/pkg/mcptools"},
	}
...
func TestBuildServerImportPath(t *testing.T) {
	testCases := []struct {
		...
		{"simple", "mymcpserver", "mymcpserver/pkg/mcpserver"},
		{"nested", "output/myserver", "myserver/pkg/mcpserver"},
	}
